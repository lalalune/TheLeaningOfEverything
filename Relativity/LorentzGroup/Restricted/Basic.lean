...
This file defines the restricted Lorentz subgroup and develops core
group-theoretic properties used by downstream relativity modules.

-/

-- NOTE (`6VZNP`): Prove that every element of the restricted Lorentz group
-- decomposes as a boost composed with a rotation.
