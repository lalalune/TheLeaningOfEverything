...
-/
-- NOTE (`6V2FP`): Redefine the gauge group as a quotient of
-- `SU(3) × SU(2) × U(1)` by a subgroup of `ℤ₆`.
...
-/
def gaugeGroupℤ₆SubGroup [inst : Group GaugeGroupI] : Subgroup GaugeGroupI := ⊥
